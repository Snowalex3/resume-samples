...
class Ship{
 public:
  ...
  int CheckRecipeMaterial1( Material material);

  // Name: CheckRecipeMaterial1(Material material)
  // Desc - Checks to find the second recipe materials index
  // Preconditions - The recipe is valid
  // Postconditions - Returns index of material 2
  int CheckRecipeMaterial2( Material material);
